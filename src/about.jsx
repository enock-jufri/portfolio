        ...
        <div className="mt-20 flex justify-center gap-[130px]">
            ...
            <div className="">
                ...
                <div className="flex gap-4 mt-10 mb-12 ">
                    <img src="/Tech Stack Logos (1).png" alt="" />
                    <img src="/Tech Stack Logos (2).png" alt="" />
                    <img src="/Tech Stack Logos (3).png" alt="" />
                    <img src="/Tech Stack Logos (4).png" alt="" />
                    <img src="/Tech Stack Logos (5).png" alt="" />
                </div>
                <a
                    href="/Enock cv.pdf"
                    download
