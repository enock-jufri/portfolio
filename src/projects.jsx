        ...
        <div className=" grid grid-cols-2 gap-5">
            {
                projects.map((Project, index) => (
                    <div key={index} className="p-4 rounded-2xl bg-gray-800 shadow-md">
                        <div className="h-5 rounded w-1/2 mb-1 font-bold">
                            {Project.name}
                        </div>
                        <div className="h-4 rounded w-1/2 mb-3">{Project.synopsis}</div>
                        ...
                        <div className="h-10 rounded mb-4">
                            {Project.description}
                        </div>
                        <div className="flex rounded w-1/2 mb-0 gap-5">
